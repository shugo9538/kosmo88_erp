				...
				<div class="dropdown-menu dropdown-menu-head pull-right">
					...
					<ul class="dropdown-list normal-list">
						<li class="message-list message-scroll-list">
							<a href="#">
								<span class="photo">
									<img src="${RESOURCES_PATH}/assets/images/users/avatar-8.jpg" class="img-circle" alt="img">
								</span>
							...
							<a href="#">
								<span class="photo">
									<img src="${RESOURCES_PATH}/assets/images/users/avatar-7.jpg" class="img-circle" alt="img">
								</span>
								<span class="subject">John Doe</span>
								<span class="message"> New tasks needs to be done</span>
							...
							<a href="#">
								<span class="photo">
									<img src="${RESOURCES_PATH}/assets/images/users/avatar-6.jpg" class="img-circle" alt="img">
								</span>
								<span class="subject">John Doe</span>
								<span class="message"> New tasks needs to be done</span>
