...
public class SlipDTO {
	...
	private String abs;  //abstract 예약어로 변경||
	...
	public String toString() {
		return "SlipDTO [id=" + id + ", type=" + type + ", register_date=" + register_date + ", update_date="
				...
				+ department_request + ", request_id=" + request_id + ", sales_price=" + sales_price + ", quantity="
				+ quantity + ", total=" + total + ", item_name=" + item_name + ", sum_supply=" + sum_supply
				+ ", sum_tax=" + sum_tax + ", sum_total=" + sum_total + ", expenses=" + expenses + ", account_title="
				+ account_title + ", abs=" + abs + ", purchase_price=" + purchase_price + ", slip_id=" + slip_id
				+ ", client_id=" + client_id + ", client_name=" + client_name + ", client_ceo_name=" + client_ceo_name
				+ ", client_num=" + client_num + ", client_phone=" + client_phone + ", client_email=" + client_email
				+ ", employee_id=" + employee_id + ", employee_photo=" + employee_photo + ", employee_name="
				+ employee_name + ", employee_phone=" + employee_phone + ", employee_email=" + employee_email
				+ ", hire_date=" + hire_date + ", department_name=" + department_name + "]";
	}
