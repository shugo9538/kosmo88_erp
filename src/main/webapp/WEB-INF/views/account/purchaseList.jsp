                                    ...
                                    <!-- 등록 매출/매입전표가 있는경우 --> 
                                     ...
                                     <tr>
                                     	...
                                     	<c:if test="${startPage > pageBlock}">
                                     		<a href="${ROOT_PATH}/account/purchaseList?categoryNum=132" style="color:block">[◀◀]</a>
                                     		<a href="${ROOT_PATH}/account/purchaseList?categoryNum=132&pageNum=${startPage-pageBlock}" style="color:block">[◀]</a>
                                     	</c:if>
                                     	...
                                     	<c:forEach var="i" begin="${startPage}" end="${endPage}">
                                     		...
                                     		<c:if test="${i != currengPage}">
                                     			<a href="${ROOT_PATH}/account/purchaseList?categoryNum=132&pageNum=${i}">[${i}]</a>
                                     		</c:if>
                                     	</c:forEach>
                                     	<!-- 다음블록[▶▶] / 맨마지막블럭[▶]  -->
                                     	<c:if test="${pageCount > endPage}">
                                     		<a href="${ROOT_PATH}/account/purchaseList?categoryNum=132&pageNum=${startPage + pageBlock}">[▶]</a>
                                     		<a href="${ROOT_PATH}/account/purchaseList?categoryNum=132&pageNum=${pageCount}">[▶▶]</a>
                                     	</c:if>
                                     	</th>
                                     	</tr>
                                     </c:if>
