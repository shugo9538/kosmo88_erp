			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="white-box" id="white-box">
						<form class="form-horizontal" name="clientRegisterForm" id="clientRegisterForm"
						...
						>
							...
							<table id="client" class="display table mt-12" style="width: 100%">
								<tr>
									...
									<td>
										<input type="text" name="name" id="name" required placeholder="거래처명">
									</td>
								...
								<tr>
									...
									<td>
										<input type="text" name="ceo_name" id="ceo_name" required placeholder="대표자">
									</td>
									<th style="background-color: #f1f1f1;">사업자 번호</th>
									<td>
										<input style="width: 50px;" type="text" id="register_num1" name="register_num1" maxlength="3" required
											onkeyup="nextRegisterNum1()"
										>
										-
										<input style="width: 50px;" type="text" id="register_num2" name="register_num2" maxlength="2" required
											onkeyup="nextRegisterNum2()"
										>
										-
										<input style="width: 50px;" type="text" id="register_num3" name="register_num3" maxlength="5" required
								...
								<tr>
									...
									<td>
										<input style="width: 50px;" type="text" id="phone1" name="phone1" maxlength="3" required
											onkeyup="nextPhone1()"
										>
										-
										<input style="width: 50px;" type="text" id="phone2" name="phone2" maxlength="4" required
											onkeyup="nextPhone2()"
										>
										-
										<input style="width: 50px;" type="text" id="phone3" name="phone3" maxlength="4" required
											onkeyup="nextPhone3()"
										>
									</td>
								</tr>
							...
							<table id="insertItemTable" class="table table-hover" style="width: 100%">
								...
								<tbody id="item-group">
									<tr id="item" style="display: none;">
										...
										<td>
											<input class="form-control" name="item_name" type="text" placeholder="상품명" disabled>
										</td>
										<td>
											<input class="form-control" name="category" type="text" placeholder="상품종류" disabled>
										</td>
										<td>
											<input class="form-control" name="price" type="number" min="0" placeholder="상품가격" disabled>
										</td>
										<td>
							...
							<div class="form-group mt-5">
								<div class="col-md-5 col-md-offset-5">
									<input class="btn  btn-primary" id="clientRegisterAction" type="button" value="등록">
