...
<body class="sticky-header">
	...
	<div class="main-content">
		...
		<div class="wrapper">
			...
			<div class="white-box">
	            <div class="col-md-14">
	                ...
	                <form class="form-horizontal">
	                  ...
	                  <div class="form-group">
						 <label class="col-md-1 control-label">거래처 대표자명</label>
	                     <div class="col-md-3">
			...
			<div class="white-box">
	            <div class="col-md-14">
	            	<h4 class="page-title">견적서 품목내역</h4>
        			<div class="table-responsive">
					  <div class="col-md-2 col-md-offset-10">
                          <input class="btn btn-primary" type="button" value="품목추가">
                          <input class="btn btn-primary" type="reset" value="품목삭제">
                      </div>
