	...
	<div class="main-content">
		...
		<div class="wrapper">
			...
			<div class="page-title-box">
				...
				<ol class="breadcrumb">
					<li><a href="${ROOT_PATH}/purchase/purchaseManagement">발주서 관리</a></li>
					...
					<div class="white-box">
						<div class="col-md-12">
							<h2 class="header-title">
								<i class="fa fa-chevron-circle-right mr-2"></i>발주서
							</h2>
						...
						<div class="col-md-12 mt-5">
							<h2 class="header-title">
								<i class="fa fa-chevron-circle-right mr-2"></i>발주서 품목내역
							</h2>
