	...
	<div class="col-md-6">
		<div class="white-box">
			...
			<ul class="list-inline text-center m-t-10">
				<li>
					<h5>
						<i class="fa fa-circle m-r-5" style="color: #98C1D1;"></i> Iphone
					</h5>
				</li>
				<li>
					<h5>
						<i class="fa fa-circle m-r-5" style="color: #23DBDE;"></i> Ipad
					</h5>
				</li>
				<li>
					<h5>
						<i class="fa fa-circle m-r-5" style="color: #F6DDA0;"></i> Itouch
					</h5>
				</li>
			</ul>
	...
	<div class="col-md-6">
		<div class="white-box">
			...
			<ul class="list-inline text-center m-t-10">
				<li>
					<h5>
						<i class="fa fa-circle m-r-5" style="color: #03A9F3;"></i> Section
						A
					</h5>
				</li>
				<li>
					<h5>
						<i class="fa fa-circle m-r-5" style="color: #FFAA00;"></i> Section
						B
					</h5>
				</li>
			</ul>
		...
		<div class="white-box">
			...
			<div class="chat-widget">
				<ul class="chat-scroll-list">
					<li class="left"><img
						src="${RESOURCES_PATH}/assets/images/users/avatar-6.jpg" alt="" />
						<div class="chat-info">
							<a class="name" href="#">Jone Doe</a> <span class="datetime">6:12</span>
			...
			<div class="row">
				<div class="col-sm-12">
					<div class="input-group">
						<input class="form-control" placeholder="Say something"
		...
		<div class="white-box">
			...
			<ul class="timeline timeline-compact">
				<li class="latest">
					...
					<div class="timeline-description">Lorem Ipsum generators on
						the tend to repeat.</div>
				</li>
				<li>
					<div class="timeline-date">Just Now</div>
