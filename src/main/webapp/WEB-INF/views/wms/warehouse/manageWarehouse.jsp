										...
										<tbody>
											<c:forEach var="dto" items="${warehouseDtoList}">
												<tr>
													<td>1</td>
													<td><a
														href="${ROOT_PATH}/wms/warehouse/manageWarehouse?id=${dto.warehouse_id}">${dto.warehouse_name}</a></td>
													<td>${dto.section_count}</td>
													<td>${dto.capacity_sum}</td>
													<td>
														<div class="progress progress-striped progress-sm">
														<fmt:formatNumber var="loadRate" value="${dto.loaded_sum/dto.capacity_sum*100}" pattern="#.##"/>
