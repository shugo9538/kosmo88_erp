        ...
        columns : [
        		{
                    ...
                    render : function(data, type, row, meta) {
                        return '<a href="/logistics_erp/purchase/orderDetail?request_id=' + row.request_id + '" onclick="window.open(this.href, width=1900, height=1200); return false;">' + row.request_id + '</a>'; 
                    }
                }, {
                	data : 'client_name',
                }, {	
